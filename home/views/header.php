...
<div class="entry d-flex">
  ...
  <a href="login.php" class="glossy-button btn btn-danger mt-2 me-2 mb-3" id="loginBtn">Log In</a>
  <a href="registration.php" class="glossy-button btn btn-success mt-2 me-5 mb-3" id="signupBtn">Sign Up</a>
  <i class="fas fa-pen text-primary" style="position: absolute; top: 1rem; right: 7.8rem;"></i>
</div>
<!-- //Login Signup buttons -->
		      </div>
		    </div>
