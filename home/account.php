<?php 
	...
	require_once "config.php";
      ...
      $sql = "SELECT * FROM job_posting WHERE status = 0";
      $stmt = $db->prepare($sql);
      $count = $stmt->execute();
              ...
              if ($count>0) {
                while ($result = $stmt->fetch(PDO::FETCH_ASSOC)) {
                  ...
                  echo '<li><a class="dropdown-item text-primary" href="viewJob.php?id='.$result['id'].'">'.$result['description'].'</a></li>';
                  echo '<li><hr class="dropdown-divider"></li>';
                }
              }
              else{
                echo '<li><a class="dropdown-item text-danger font-weight-bold" href="#"><i class="fas fa-sad-tear"></i>Sorry No message</a></li>';
              }
            ?>
						        ...
						        <div class="dropdown-menu-content">
							       <div class="item p-3">
								        <div class="row gx-2 justify-content-between align-items-center">
									        <div class="col-auto">
										       <img class="profile-image" src="../img/photos/a5.png" alt="">
									        </div><!--//col-->
									        <div class="col">
										        <div class="info"> 
        ...
        <div id="app-sidepanel" class="app-sidepanel sidepanel-hidden"> 
	        ...
	        <div class="sidepanel-inner d-flex flex-column">
		        ...
		        <div class="app-branding">
		            <a class="app-logo" href="index.php"><img class="logo-icon me-2" src="../img/app-logo.svg" alt="logo"><span class="logo-text">PORTAL</span></a>
							    ...
							    <div class="item border-bottom py-3">
								    <div class="row justify-content-between align-items-center">
									    <div class="col-auto">
										    ...
										    <div class="item-data"><img class="profile-image" src="../img/photos/a5.png" alt=""></div>
									    </div><!--//col-->
