...
<?php
	...
	try {
	    ...
	    $mail->Subject = "Welcome to Freelance Web Portal";
	    $mail->Body    = "<p>Congratulation! You are successfully registered with us.<br><br>This is a system generated message. Please don't reply to this email.<br><br></p>";
