...
<?php
	...
	try {
	    ...
	    <a href='".PROJECT_NAME."resetPassword.php?email=".$user[0]["email"]."&token=".$token."'
	    style='
	    	...
	    	padding:.75em 1.5em;border:1px solid #28a745'>Reset Your Password</a><br><br>Please do not share this e-mail with anyone. If you did not request to reset your password, kindly ignore this e-mail.<br><br></p>";
